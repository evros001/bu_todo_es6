...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TasksComponentTasksContainerJs = __webpack_require__(185);

	var _TasksComponentTasksContainerJs2 = _interopRequireDefault(_TasksComponentTasksContainerJs);

	var _TeamComponentTeamContainerJs = __webpack_require__(191);

	var _TeamComponentTeamContainerJs2 = _interopRequireDefault(_TeamComponentTeamContainerJs);

	var _TaskDetailsComponentTaskDetailsContainerJs = __webpack_require__(192);
		...
		_createClass(ToDoContainer, [{
			...
			value: function handleProjectSelect(selectedProject) {
				...
				this.setState({
					...
					return _this.state.selectedProject.shift();
				});
			}
		}, {
			key: 'render',
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(_TasksComponentTasksContainerJs2['default'], { projectSelected: this.state.selectedProject }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddProjectJs = __webpack_require__(165);

	var _AddProjectJs2 = _interopRequireDefault(_AddProjectJs);

	var _ProjectJs = __webpack_require__(166);
		...
		_createClass(ProjectsContainer, [{
			...
			value: function render() {
				...
				var projectList = this.state.projects.map(function (project, index) {
					return _react2['default'].createElement(_ProjectJs2['default'], {
						key: index,
						project: project,
						remove: _this.handleRemoveProject.bind(_this),
						selected: _this.handleSelectProject.bind(_this)
					});
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddons = __webpack_require__(167);
		...
		_createClass(Project, [{
			...
			value: function handleSelected() {
				...
				if (this.state.selected === false) {
					this.setState({
						...
						return _this.props.selected(_this.props.project);
					});
				} else if (this.state.selected === true) {
					this.setState({
						selected: false
					}, function () {
						return _this.props.selected("all");
					});
				}
			}
		}, {
			...
			value: function render() {
				...
				return _reactAddons2['default'].createElement(
					'li',
					{ className: classes, onClick: (_context = this.handleSelected).bind.call(_context, this, index) },
					_reactAddons2['default'].createElement('i', { className: 'fa fa-circle' }),
					_reactAddons2['default'].createElement(
						'span',
						null,
						project
					),
					_reactAddons2['default'].createElement('i', { className: 'fa fa-times', onClick: (_context = this.props.remove).bind.call(_context, this, index) })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TaskJs = __webpack_require__(186);

	var _TaskJs2 = _interopRequireDefault(_TaskJs);

	var _AddTaskJs = __webpack_require__(189);

	var _AddTaskJs2 = _interopRequireDefault(_AddTaskJs);

	var _TaskScheduleJs = __webpack_require__(190);
	...
	var TasksContainer = (function (_React$Component) {
		...
		function TasksContainer() {
			...
			_get(Object.getPrototypeOf(TasksContainer.prototype), 'constructor', this).apply(this, arguments);
		...
		_createClass(TasksContainer, [{
			key: 'handleAddTask',
			value: function handleAddTask(newTask) {
				this.setState({
				...
				var taskList = this.state.tasks.map(function (task, index) {
					...
					return _react2['default'].createElement(
						...
						_react2['default'].createElement(
							'span',
							null,
							_react2['default'].createElement(_TaskJs2['default'], { title: task, projectSelected: _this.props.projectSelected[0][0] })
						)
					);
				});
				return _react2['default'].createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AddItemJs = __webpack_require__(187);

	var _AddItemJs2 = _interopRequireDefault(_AddItemJs);

	var _ItemsJs = __webpack_require__(188);
	        ...
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(_ItemsJs2['default'], { items: this.state.items, remove: this.handleRemove.bind(this) }),
	                    _react2['default'].createElement(_AddItemJs2['default'], { add: this.handleAddItem.bind(this) })
	                )
	            );
	        }
	    }]);
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement('input', { type: 'text', onChange: this.handleChange.bind(this), value: this.state.newItem }),
						_react2['default'].createElement(
							'button',
							{ type: 'submit' },
							'Schedule'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddTask = (function (_React$Component) {
		...
		function AddTask() {
			...
			_get(Object.getPrototypeOf(AddTask.prototype), 'constructor', this).apply(this, arguments);
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'form',
						{ onSubmit: this.handleSubmit.bind(this) },
						_react2['default'].createElement('input', { type: 'text', onChange: this.handleChange.bind(this), value: this.state.newTask }),
						_react2['default'].createElement(
							'button',
							{ type: 'submit' },
							'Add Task'
